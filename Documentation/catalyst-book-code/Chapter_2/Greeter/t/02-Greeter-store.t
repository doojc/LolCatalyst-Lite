...
# greet guest
 cmp_ok($greeter->greet('Homer'), 'eq',
       'Hello Homer, I hope you are having a nice visit',
       'greet guest');

# greet unknown
cmp_ok($greeter->greet('Pappa Smurf'), 'eq',
       "Hello Pappa Smurf, I don't know you, do I?",
       'greet unknown');
...
# greet guest with member's greeting
...
# try to greet guest with unknown
 cmp_ok( $greeter->greet('Bart', 'Pappa Smurf'), 'eq',
       "Hello Pappa Smurf, I don't know you, do I?",
       'greet unknown 2');

 # try to greet unknown with guest
 cmp_ok( $greeter->greet('Pappa Smurf', 'Bart'), 'eq',
