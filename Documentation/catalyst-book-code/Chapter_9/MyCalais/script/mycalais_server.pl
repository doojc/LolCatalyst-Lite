...
my $help              = 0;
my $host              = undef;
my $port              = $ENV{MYCALAIS_PORT} || $ENV{CATALYST_PORT} || 3000;
my $keepalive         = 0;
my $restart           = $ENV{MYCALAIS_RELOAD} || $ENV{CATALYST_RELOAD} || 0;
my $background        = 0;
my $pidfile           = undef;
...
mycalais_server.pl - Catalyst Testserver

=head1 SYNOPSIS

mycalais_server.pl [options]
