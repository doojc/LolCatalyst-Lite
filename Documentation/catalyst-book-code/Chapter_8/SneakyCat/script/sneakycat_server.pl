...
my $help              = 0;
my $host              = undef;
my $port              = $ENV{SNEAKYCAT_PORT} || $ENV{CATALYST_PORT} || 3000;
my $keepalive         = 0;
my $restart           = $ENV{SNEAKYCAT_RELOAD} || $ENV{CATALYST_RELOAD} || 0;
my $background        = 0;
my $pidfile           = undef;
...
sneakycat_server.pl - Catalyst Testserver

=head1 SYNOPSIS

sneakycat_server.pl [options]
